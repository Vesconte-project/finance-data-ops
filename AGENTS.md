...
Before acting, read `Vesconte-project/company-os/AGENTS.md`. Company-level operating
rules there govern this repository. If this repository conflicts with Company OS, stop
and report the conflict rather than guessing or silently choosing the local rule.
